package com.rajitha.kafkademo.producer.stream;

import com.rajitha.kafkademo.producer.producer.WikimediaProducer;
...
public class WikimediaStreamConsumer {
    ...
    public void consumeStreamAndPublish(){
        webClient.get()
                ...
                .doOnNext(data -> log.info("Wikimedia Event: {}", data))
